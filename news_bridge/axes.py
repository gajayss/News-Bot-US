...
AXES: dict[str, AxisProfile] = {
    ...
    "CORPORATE": AxisProfile(
        ...
        event_types=["SHORT_SELLING", "HEDGEFUND", "EARNINGS", "ANALYST", "INSIDER"],
        speed="MEDIUM",
        ...
        description="어닝/가이던스/애널리스트/헤지펀드포지션/공매도. 세력 장난질 주의, 수량 보수적",
    ),
    "GOVERN": AxisProfile(
        axis_id="GOVERN",
        axis_name_kr="미국정부",
...
EVENT_TYPE_KEYWORDS: dict[str, list[str]] = {
    ...
    "INSIDER":    ["insider", "director sold", "ceo sold", "stake sold",
                   "insider buying", "insider selling", "insider sell",
                   "insider transaction", "insider dump",
                   "cfo sold", "coo sold", "cto sold", "vp sold",
                   "executive sold", "executive sells",
                   "officers sold", "officer selling",
                   "massive insider", "insider volume",
                   "board member sold", "board member sells",
                   "brother sold", "family sold", "family member",
                   "kimbal musk", "musk sold", "musk sells",
                   "jensen huang", "huang sold", "huang sells",
                   "ceo unloads", "ceo dumps",
                   "form 4", "sec form 4"],
    "HEDGEFUND":  ["michael burry", "burry", "scion asset", "scion capital",
                   "citron research", "citron", "hindenburg", "hindenburg research",
                   "muddy waters", "iceberg research", "wolfpack research",
                   "spruce point", "grizzly research", "kerrisdale",
                   "hedge fund", "hedgefund", "13f", "13f filing",
                   "activist investor", "activist stake",
                   "ackman", "bill ackman", "pershing square",
                   "carl icahn", "icahn", "dan loeb", "third point",
                   "elliott management", "elliott activist",
                   "david einhorn", "greenlight capital",
                   "ray dalio", "bridgewater", "ken griffin", "citadel",
                   "george soros", "soros fund",
                   "cathie wood", "ark invest", "ark sells", "ark buys",
                   "tiger global", "coatue", "druckenmiller",
                   "berkshire", "buffett", "warren buffett",
                   "portfolio change", "position change",
                   "trims stake", "increases stake", "exits position",
                   "builds position", "new position", "closes position"],
    "SHORT_SELLING": ["short seller", "short selling", "short report",
                      "short interest", "short squeeze", "heavily shorted",
                      "most shorted", "short target", "shorting",
                      "bear case", "fraud allegation", "accounting fraud",
                      "inflated revenue", "overvalued", "house of cards",
                      "channel checks negative", "channel stuffing",
                      "related party transaction", "dilution risk"],
    # 축3: GOVERN
